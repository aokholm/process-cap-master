...
The 90 \% cumulative frequency corresponds to an 14.2 IT grade. The plot contains 77 independent measurements and an standard deviation of around 1 IT-grade, which results in a total uncertainty of around 0.3 IT Grades figure \ref{fig:confidenceIntervals} i   
...
Traditionally mechanical designer apply tolerances needed for functionality of a product with little regard PC. From figure \ref{fig:ITG_ITGSpec} the correlation between the specified tolerance and the actual precision measured is shown. There is non.
Robust design methodology propose method of design based on PC. A design that at robust in relation to variance The dotted line in figure \ref{fig:ITG_ITGSpec} represent 90 \% of data corresponding to a IT grade of $14.2$  or 90 \% probability in figure \ref{fig:acumfreq}. A design that in robust in relation to variance 
