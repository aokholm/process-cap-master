...
To test the concept an experimental database were made. Vaavud, a company making small anemometers, provided technical drawings and samples for the project. 
All four different parts investigated were injection moulded. Three parts is made of polyoxymethylene (POM) filled with polytetrafluoroethylene (PTFE) in the same mould. 
The fourth part is the rotor of the anemometers, which is made using a blend of polycarbonate (PC) and a acrylonitrile butadiene styrene (ABS).
This mould had two 
The measurements data in our the database comes from the manufactures  
...
Robust design methodology propose method of design based on PC. The dotted line in figure \ref{fig:ITG_ITGSpec} represent 80 \% of data corresponding to 80 \% probability $. 



long and slender

Unnecessay tight tolerances in not critical areas.

miss communication between production and design department
