...
Robust design methodology propose method of design based on PC. The dotted line in figure \ref{fig:ITG_ITGSpec} represent 90 \% of data corresponding to a IT grade of $14.2$  or 90 \% probability in figure \ref{fig:acumfreq}. A design that in robust in relation to variance 
