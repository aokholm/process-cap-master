...
The data is normalised to relate the specific tolerance limits independent of size. By normalising PC data it can be used to predict PC for any dimension within the limit of the normalisation algorithm. 
